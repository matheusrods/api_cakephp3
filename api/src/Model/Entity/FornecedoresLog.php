 ...
 * @property int|null $cobranca_boleto
 ...
 * @property int|null $faturamento_dias
 * @property string|null $faturamento_detalhes
 * @property string|null $caminho_arquivo
 * @property string|null $observacao
 * @property string|null $dia_pagamento
 * @property int|null $ambulatorio
 * @property int|null $ambulatorio_codigo_cliente
 * @property bool $prestador_particular
 */
class FornecedoresLog extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'data_alteracao' => true,
        'acao_sistema' => true,
        'cobranca_boleto' => true,
        'cnes' => true,
        'codigo_fornecedor_recebedor' => true,
        'prestador_qualificado' => true,
        'modalidade_pagamento' => true,
        'faturamento_dias' => true,
        'faturamento_detalhes' => true,
        'caminho_arquivo' => true,
        'observacao' => true,
        'dia_pagamento' => true,
        'ambulatorio' => true,
        'ambulatorio_codigo_cliente' => true,
        'prestador_particular' => true,
    ];
}
