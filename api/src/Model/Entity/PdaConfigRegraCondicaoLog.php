...
/**
 * PdaConfigRegraCondicaoLog Entity
 *
 * @property int $codigo
 * @property int $codigo_pda_config_regra_condicao
 ...
 */
class PdaConfigRegraCondicaoLog extends Entity
{
    /**
    ...
    protected $_accessible = [
        'codigo_pda_config_regra_condicao' => true,
        'codigo_empresa' => true,
        'codigo_cliente' => true,
