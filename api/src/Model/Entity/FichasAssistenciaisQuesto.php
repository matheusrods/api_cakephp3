...
/**
 * FichasAssistenciaisQuesto Entity
 *
 * @property int $codigo
 * @property int $codigo_ficha_assistencial_grupo_questao
 * @property int|null $codigo_ficha_assistencial_questao
 ...
 */
class FichasAssistenciaisQuesto extends Entity
{
    /**
    ...
    protected $_accessible = [
        'codigo_ficha_assistencial_grupo_questao' => true,
