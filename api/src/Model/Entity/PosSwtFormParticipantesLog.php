...
/**
 * PosSwtFormParticipantesLog Entity
 *
 * @property int $codigo
 * @property int|null $codigo_form_participantes
 ...
 */
class PosSwtFormParticipantesLog extends Entity
{
    /**
    ...
    protected $_accessible = [
        'codigo_form_participantes' => true,
        'codigo_form' => true,
        'codigo_cliente' => true,
        'codigo_empresa' => true,
        'codigo_usuario' => true,
