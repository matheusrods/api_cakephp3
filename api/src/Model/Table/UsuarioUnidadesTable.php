 ...
 * @method \App\Model\Entity\UsuarioUnidade|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UsuarioUnidade saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 */
class UsuarioUnidadesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('usuario_unidades');
