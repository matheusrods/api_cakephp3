...
/**
 * OnboardingClienteFixture
 */
class OnboardingClienteFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'onboarding_cliente';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'codigo_onboarding' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_onboarding_cliente_codigo_onboarding' => ['type' => 'foreign', 'columns' => ['codigo_onboarding'], 'references' => ['onboarding', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1606402055,
                'codigo_usuario_inclusao' => 1,
                'data_alteracao' => 1606402055,
