...
/**
 * OnboardingClienteLogFixture
 */
class OnboardingClienteLogFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'onboarding_cliente_log';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'codigo_onboarding_cliente' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        'acao_sistema' => ['type' => 'tinyinteger', 'length' => 3, 'null' => true, 'default' => '0', 'precision' => null, 'comment' => null, 'unsigned' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['codigo'], 'length' => []],
            'fk_onboarding_cliente_log__codigo_onboarding' => ['type' => 'foreign', 'columns' => ['codigo_onboarding'], 'references' => ['onboarding_cliente', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
