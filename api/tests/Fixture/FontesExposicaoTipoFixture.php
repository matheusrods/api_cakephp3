...
/**
 * FontesExposicaoTipoFixture
 */
class FontesExposicaoTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'fontes_exposicao_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1596471415,
                'data_alteracao' => 1596471415,
            ],
        ];
        parent::init();
    }
