...
/**
 * HazopsMedidasControleAnexosFixture
 */
class HazopsMedidasControleAnexosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'codigo_hazop_medida_controle' => ['type' => 'integer', 'length' => 10, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_hmca_codigo_hazop_medida_controle' => ['type' => 'foreign', 'columns' => ['codigo_hazop_medida_controle'], 'references' => ['hazops_medidas_controle', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                'codigo' => 1,
                'codigo_hazop_medida_controle' => 1,
                'arquivo_url' => 'Lorem ipsum dolor sit amet',
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1600633464,
                'data_alteracao' => 1600633464,
            ],
        ];
        parent::init();
    }
