...
/**
 * FornecedoresHistoricoFixture
 */
class FornecedoresHistoricoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'fornecedores_historico';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'caminho_arquivo' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'PK_fornecedores_historico__codigo_fornecedor' => ['type' => 'foreign', 'columns' => ['codigo_fornecedor'], 'references' => ['fornecedores', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1589512519,
                'codigo_usuario_inclusao' => 1,
                'data_alteracao' => 1589512519,
