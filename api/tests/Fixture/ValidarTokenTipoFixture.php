...
/**
 * ValidarTokenTipoFixture
 */
class ValidarTokenTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'validar_token_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1604949901,
                'data_alteracao' => 1604949901,
            ],
        ];
        parent::init();
    }
