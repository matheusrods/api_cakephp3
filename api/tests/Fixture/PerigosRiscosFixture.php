...
/**
 * PerigosRiscosFixture
 */
class PerigosRiscosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'codigo_perigo_risco_tipo' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_pr_codigo_perigo_risco_tipo' => ['type' => 'foreign', 'columns' => ['codigo_perigo_risco_tipo'], 'references' => ['perigos_riscos_tipo', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'codigo_perigo_risco_tipo' => 1,
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1596475766,
                'data_alteracao' => 1596475766,
            ],
        ];
        parent::init();
    }
