...
class CaracteristicasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'titulo' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        'alerta' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1575314663,
                'codigo_usuario_alteracao' => 1,
                'data_alteracao' => 1575314663,
                'codigo_empresa' => 1,
                'ativo' => 1
            ],
        ];
