...
/**
 * FornecedoresContatoLogFixture
 */
class FornecedoresContatoLogFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'fornecedores_contato_log';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'codigo_fornecedor_contato' => ['type' => 'smallinteger', 'length' => 5, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null],
        ...
        'descricao' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk_fornecedores_contato_log__codigo_fornecedor' => ['type' => 'foreign', 'columns' => ['codigo_fornecedor'], 'references' => ['fornecedores', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ramal' => 1,
                'data_inclusao' => 1595862177,
                'codigo_usuario_inclusao' => 1,
                'codigo_empresa' => 1,
                'acao_sistema' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_alteracao' => 1595862177,
            ],
        ];
        parent::init();
    }
