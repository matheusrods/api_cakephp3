...
/**
 * AgentesRiscosEtapasFixture
 */
class AgentesRiscosEtapasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'codigo_processo_ferramenta' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_are_codigo_processo_ferramenta' => ['type' => 'foreign', 'columns' => ['codigo_processo_ferramenta'], 'references' => ['processos_ferramentas', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'codigo_processo_ferramenta' => 1,
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1596465501,
                'data_alteracao' => 1596465501,
            ],
        ];
        parent::init();
    }
