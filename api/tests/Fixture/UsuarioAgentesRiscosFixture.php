...
/**
 * UsuarioAgentesRiscosFixture
 */
class UsuarioAgentesRiscosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'data_assinatura' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'getdate', 'precision' => null, 'comment' => null],
        'arquivo_url' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'fk_ugr_codigo_arrtpa_ri' => ['type' => 'foreign', 'columns' => ['codigo_arrtpa_ri'], 'references' => ['arrtpa_ri', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'codigo_arrtpa_ri' => 1,
                'codigo_usuario' => 1,
                'data_assinatura' => 1601504611,
                'arquivo_url' => 'Lorem ipsum dolor sit amet',
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1601504611,
                'data_alteracao' => 1601504611,
            ],
        ];
        parent::init();
    }
