...
/**
 * RiscosImpactosFixture
 */
class RiscosImpactosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'codigo_perigo_aspecto' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_ri_codigo_perigo_aspecto' => ['type' => 'foreign', 'columns' => ['codigo_perigo_aspecto'], 'references' => ['perigos_aspectos', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'codigo_perigo_aspecto' => 1,
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1596765009,
                'data_alteracao' => 1596765009,
            ],
        ];
        parent::init();
    }
