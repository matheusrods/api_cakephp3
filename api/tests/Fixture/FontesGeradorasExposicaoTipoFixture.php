...
/**
 * FontesGeradorasExposicaoTipoFixture
 */
class FontesGeradorasExposicaoTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'fontes_geradoras_exposicao_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1596767443,
                'data_alteracao' => 1596767443,
            ],
        ];
        parent::init();
    }
