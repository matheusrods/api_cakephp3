...
/**
 * LynMenuClienteLogFixture
 */
class LynMenuClienteLogFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'lyn_menu_cliente_log';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'codigo_lyn_menu_cliente' => ['type' => 'integer', 'length' => 10, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'codigo' => 1,
                'codigo_lyn_menu_cliente' => 1,
                'codigo_lyn_menu' => 1,
                'codigo_cliente' => 1,
                'codigo_usuario_inclusao' => 1,
                'data_inclusao' => 1600171310,
                'codigo_usuario_alteracao' => 1,
                'data_alteracao' => 1600171310,
            ],
        ];
        parent::init();
    }
