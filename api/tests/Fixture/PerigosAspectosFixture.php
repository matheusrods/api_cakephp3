...
/**
 * PerigosAspectosFixture
 */
class PerigosAspectosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'codigo_perigo_aspecto_tipo' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'fk_pa_codigo_perigo_aspecto_tipo' => ['type' => 'foreign', 'columns' => ['codigo_perigo_aspecto_tipo'], 'references' => ['perigos_aspectos_tipo', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'codigo_risco_tipo' => 1,
                'codigo_perigo_aspecto_tipo' => 1,
                'codigo_usuario_inclusao' => 1,
                'codigo_usuario_alteracao' => 1,
                'data_inclusao' => 1596763983,
                'data_alteracao' => 1596763983,
            ],
        ];
        parent::init();
    }
