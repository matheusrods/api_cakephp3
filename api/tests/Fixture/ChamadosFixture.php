...
class ChamadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'codigo_chamado_tipo' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        'codigo_chamado_status' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['codigo'], 'length' => []],
            'fk_c_codigo_chamado_tipo' => ['type' => 'foreign', 'columns' => ['codigo_chamado_tipo'], 'references' => ['chamados_tipo', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_cs_codigo_chamado_status' => ['type' => 'foreign', 'columns' => ['codigo_chamado_status'], 'references' => ['chamados_status', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1595617074,
                'data_alteracao' => 1595617074,
