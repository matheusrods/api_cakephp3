...
/**
 * PerigosRiscosTipoFixture
 */
class PerigosRiscosTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'perigos_riscos_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'cor' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
        'icone' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'SQL_Latin1_General_CP1_CI_AS', 'precision' => null, 'comment' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1596470257,
                'data_alteracao' => 1596470257,
            ],
        ];
        parent::init();
    }
