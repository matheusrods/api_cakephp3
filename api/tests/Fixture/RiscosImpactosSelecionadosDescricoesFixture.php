...
/**
 * RiscosImpactosSelecionadosDescricoesFixture
 */
class RiscosImpactosSelecionadosDescricoesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_risd_codigo_risco_impacto_selecionado' => ['type' => 'foreign', 'columns' => ['codigo_risco_impacto_selecionado'], 'references' => ['riscos_impactos_selecionados', 'codigo'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1597176940,
                'data_alteracao' => 1597176940,
            ],
        ];
        parent::init();
    }
