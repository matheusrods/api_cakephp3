...
/**
 * MedidasControleHierarquiaTipoFixture
 */
class MedidasControleHierarquiaTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'medidas_controle_hierarquia_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1596478393,
                'data_alteracao' => 1596478393,
            ],
        ];
        parent::init();
    }
