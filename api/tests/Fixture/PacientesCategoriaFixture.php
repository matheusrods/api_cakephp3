...
/**
 * PacientesCategoriaFixture
 */
class PacientesCategoriaFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'pacientes_categoria';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        'codigo_usuario_alteracao' => ['type' => 'integer', 'length' => 10, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'unsigned' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1587151558,
                'data_alteracao' => 1587151558,
                'ativo' => 1,
                'codigo_empresa' => 1,
            ],
        ];
