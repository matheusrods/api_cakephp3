...
/**
 * PerigosAspectosTipoFixture
 */
class PerigosAspectosTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'perigos_aspectos_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1596763455,
                'data_alteracao' => 1596763455,
            ],
        ];
        parent::init();
    }
