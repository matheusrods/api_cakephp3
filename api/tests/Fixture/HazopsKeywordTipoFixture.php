...
/**
 * HazopsKeywordTipoFixture
 */
class HazopsKeywordTipoFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'hazops_keyword_tipo';
    /**
     * Fields
     *
     * @var array
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_inclusao' => 1600627811,
                'data_alteracao' => 1600627811,
            ],
        ];
        parent::init();
    }
